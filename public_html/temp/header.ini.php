          ...
          <form class="navbar-form navbar-left" role="search">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                    ...
                    <li>
                      <a href="./catalog.php"><span class="glyphicon glyphicon-fire" style="color:#F00"></span> Steam</a>
                    </li>
                    <li>
                      <a href="./catalog.php"><span class="glyphicon glyphicon-fire" style="color:#F00"></span> Origin</a>
                    </li> 
                    <li>
                      <a href="./catalog.php"><span class="glyphicon glyphicon-fire" style="color:#F00"></span> Uplay</a>
                    </li>
                    <li>
                      <a href="./catalog.php"><span class="glyphicon glyphicon-fire" style="color:#F00"></span> Steam Wallet</a>
                    </li>
